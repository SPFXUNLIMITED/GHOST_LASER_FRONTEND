...
<x-shop::layouts :logo-href="'#'">
    <x-slot:title>
        Ghost Laser | Expert Laser Machine Repair
    </x-slot>
        ...
        <div class="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            <div class="max-w-4xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ $bookTechnicianUrl }}" class="inline-flex items-center justify-center gap-2 bg-cyan-500 hover:bg-cyan-400 text-zinc-950 font-bold text-base px-7 py-3.5 rounded-md transition-all btn-glow">
                        Book a Repair
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="bg-zinc-900/60 border border-zinc-800 rounded-xl p-5 glow-box transition-all duration-300">
                        ...
                        <h3 class="font-bold text-white text-sm mb-1.5">{{ $r['title'] }}</h3>
                        <p class="text-xs text-zinc-400 leading-relaxed">{{ $r['desc'] }}</p>
                    </div>
                    @endforeach
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="relative grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="relative text-center">
                    ...
                    <h3 class="font-bold text-white text-base mb-2">{{ $st['title'] }}</h3>
                    <p class="text-sm text-zinc-400 leading-relaxed px-2">{{ $st['desc'] }}</p>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <section id="contact" class="py-24 lg:py-32 bg-zinc-900/40 border-t border-zinc-800/50">
        <div class="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div class="mb-8 flex items-start gap-3 rounded-xl border border-green-500/40 bg-green-500/10 px-5 py-4 text-left text-sm text-green-300">
                ...
                <span>{{ $contactMessage !== '' ? $contactMessage : "Thanks! Your message has been sent. We'll get back to you within 2 hours." }}</span>
            </div>
            ...
            <div class="mb-8 flex items-start gap-3 rounded-xl border border-red-500/40 bg-red-500/10 px-5 py-4 text-left text-sm text-red-300">
                ...
                <span>{{ $contactMessage !== '' ? $contactMessage : 'Something went wrong. Please check all fields and try again, or email us directly.' }}</span>
            </div>
            @endif
