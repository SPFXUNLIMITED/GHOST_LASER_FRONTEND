                            ...
                            @guest('customer')
                                <x-slot:content>
                                    ...
                                    <a
                                        ...
                                        class="m-0 mx-auto block w-max cursor-pointer rounded-2xl border-2 border-navyBlue bg-zinc-950 px-7 py-3.5 text-center text-base font-medium text-navyBlue ltr:ml-0 rtl:mr-0"
                                    >
    ...
    <script type="text/x-template" id="v-mobile-drawer-template">
            ...
            >
                ...
                @if(core()->getCurrentChannel()->locales()->count() > 1 || core()->getCurrentChannel()->currencies()->count() > 1 )
                                    <div class="fixed bottom-0 z-10 grid w-full max-w-full grid-cols-[1fr_auto_1fr] items-center justify-items-center border-t border-zinc-800 bg-zinc-950 px-5 ltr:left-0 rtl:right-0">
                                        <!-- Filter Drawer -->
                                        <x-shop::drawer
                                            position="bottom"
                                            width="100%"
                                        ...
                                        <!-- Seperator -->
                                        <span class="h-5 w-0.5 bg-zinc-800"></span>
