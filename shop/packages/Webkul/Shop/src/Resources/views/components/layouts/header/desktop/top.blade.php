...
@pushOnce('scripts')
    ...
    >
        <div class="my-2.5 grid gap-1 overflow-auto max-md:my-0 sm:max-h-[500px]">
            <span
                class="cursor-pointer px-5 py-2 text-base hover:bg-zinc-800"
                v-for="currency in currencies"
                :class="{'bg-zinc-800': currency.code == '{{ core()->getCurrentCurrencyCode() }}'}"
    ...
    >
        <div class="my-2.5 grid gap-1 overflow-auto max-md:my-0 sm:max-h-[500px]">
            <span
                class="flex cursor-pointer items-center gap-2.5 px-5 py-2 text-base hover:bg-zinc-800"
                :class="{'bg-zinc-800': locale.code == '{{ app()->getLocale() }}'}"
