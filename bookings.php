...
try {
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS service_requests (
            ...
            travel_charge        DECIMAL(10,2) NULL,
            travel_miles         DECIMAL(10,2) NULL,
            travel_estimated_hours DECIMAL(10,2) NULL,
            travel_charge_mileage_based DECIMAL(10,2) NULL,
            travel_charge_hourly_based  DECIMAL(10,2) NULL,
            travel_billing_method VARCHAR(20) NULL,
